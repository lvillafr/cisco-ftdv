...
e.g. /subscriptions/<subscription-id>/resourceGroups/blr-virtual-images-rg/providers/Microsoft.Compute/images/cisco-mcv-10.0.0-141
...
12. **vmSize**: The VM size to use for the CSF-MCv. Standard_D8_v5 is the default.<br>
Supported sizes for version 7.0 and above:<br>
  * Standard_D4_v2
  * Standard_D8_v4
  * Standard_D16_v4
  * Standard_D8s_v4
...
* [CSF-MCv deployment steps](https://www.cisco.com/c/en/us/td/docs/security/secure-firewall/management-center/management-center-virtual/management-center-virtual-gsg/fpmc-virtual-azure.html#id_106502)
