...
(4) If you are using private ip for FMCv registration then make sure that you change "USE_PUBLIC_IP_FOR_FMC_CONN" to "False" in ../lambda-python-files/constant.py. <br>
